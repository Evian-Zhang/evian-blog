...
class Neo4jClient:
    ...
    def post_article(self, article):
        ...
        body = json.dumps({"statements": [{"statement": statement, "parameters": article}]}, ensure_ascii=False)
        print("body: ")
        print(body)
    ...
    def create_indices(self):
        ...
        print("body: ")
        print(body)
        response = requests.post(self.url, data=body, headers=self.headers, ensure_ascii=False)
        print("response: ")
        print(response.text)
