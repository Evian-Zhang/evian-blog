...
RETURN {name: project.name, description: project.description, languages: project.languages, frameworks: project.frameworks, url: project.url, priority: project.priority} AS project_info
ORDER BY project_info.priority DESC";
